...
- **시각 장애인을 위한 장보기 앱 See장 @SSAFY** (2021)
  ...
  - 맡은 역할 : *Object detection, Image Classification* 구현 전반 (데이터 구축 및 학습)
- **초실감 원격가상 인터랙션을 위한 사용자 복원 기술 개발 프로젝트 @DGIST VC lab** (2018~2020)
  ...
  - 맡은 역할 : DGIST 연구 책임자로써 얼굴 표정 중 눈 부분을 집중적으로 모델링.
...
- **그래프 형태의 빅데이터 분석을 위한 알고리즘 연구 및 GPU 프로그래밍 @DGIST** (2016)
  - UGRP 프로젝트 1등
  - 맡은 역할 : *Develop & Optimize Triangle Counting algorithm*
  - 
- **사다리 타기** (2015)
